...
<acme:form>
		...
		<acme:input-textarea code="authenticated.booking.list.label.locatorCode" path="locatorCode" readonly="true"/>
		<acme:input-textbox code="authenticated.booking.list.label.purchaseMoment" path="purchaseMoment" readonly="true"/>
		<acme:input-select code="authenticated.booking.list.label.travelClass" path="travelClass" choices="${travelClass}"/>
		<acme:input-textarea code="authenticated.booking.list.label.price" path="price" readonly="true"/>
		<acme:input-textarea code="authenticated.booking.list.label.lastNibble" path="lastNibble"/>
		<acme:input-textarea code="authenticated.booking.list.label.draftMode" path="draftMode" readonly="true"/>
